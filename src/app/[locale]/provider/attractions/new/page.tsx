      ...
      <div className="max-w-4xl mx-auto px-3 sm:px-4">
        <div className="mb-6 sm:mb-10">
          <button
            ...
            className="w-full py-4 mb-6 bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 hover:from-blue-700 hover:via-purple-700 hover:to-indigo-700 text-white text-base sm:text-lg font-bold rounded-2xl shadow-xl hover:shadow-2xl transform hover:scale-[1.02] transition-all duration-300 flex items-center justify-center gap-3"
          >
            📊 Voltar ao Dashboard
          </button>
