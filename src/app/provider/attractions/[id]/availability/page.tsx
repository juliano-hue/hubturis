...
export default function ManageAvailabilityPage() {
  ...
  console.log('📅 attractionId da URL:', attractionId);
  ...
  // Selecionar intervalo de datas no calendário
  ...
  // Adicionar dias da semana recorrentes
  ...
  // Datas já disponíveis (para marcar no calendário)
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="border rounded-2xl p-6">
              ...
              {/* Configurações das datas selecionadas */}
