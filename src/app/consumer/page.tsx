...
export default function ConsumerDashboard() {
  ...
  const handleCancelBooking = async (bookingId: string, bookingDate: string) => {
    ...
    if (hoursDiff < 24) {
      alert('❌ Cancelamento não permitido. É necessário 24 horas de antecedência.');
      return;
    }
    
    if (!confirm('Tem certeza que deseja cancelar esta reserva? O reembolso será processado.')) {
      return;
    }
    ...
    try {
      ...
      alert('✅ Reserva cancelada com sucesso! O reembolso será processado.');
  ...
  // Corrigir footer - atualizar nome
  const copyright = "© 2026 HubTuris. Todos os direitos reservados.";
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-purple-50">
        <div className="text-center">
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-base sm:text-xl text-gray-600 font-medium">Carregando seu dashboard...</p>
          </div>
        </div>
      </div>
    );
      ...
      >
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm rounded-full px-3 sm:px-4 py-1 sm:py-2 mb-4 sm:mb-6">
            ...
            <span className="text-xs sm:text-sm font-medium">Bem-vindo de volta!</span>
          </div>
          ...
          <p className="text-base sm:text-xl text-gray-200 mb-6 sm:mb-8">
            {totalReservas === 0 
              ? 'Prepare-se para sua próxima aventura!' 
              : `Você já viveu ${totalReservas} experiência(s) incríveis!`}
          </p>
          ...
          <div className="flex justify-center">
            ...
            >
              🌟 Explorar Novas Atrações 🌟
            </Link>
          </div>
        </div>
      </div>

      {/* NAVEGAÇÃO RÁPIDA - RESPONSIVO */}
      <div className="relative py-3 sm:py-4 bg-white/80 backdrop-blur-sm border-b overflow-x-auto">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex justify-center gap-2 sm:gap-4 flex-wrap">
          ...
          <Link
            ...
            className="px-3 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-pink-500 to-red-500 hover:from-pink-600 hover:to-red-600 text-white rounded-full font-medium transition shadow-md hover:shadow-lg flex items-center gap-1 sm:gap-2 text-xs sm:text-base min-h-[40px]"
          >
            ❤️ Favoritos
          </Link>
          <Link
            href="/consumer/profile"
            className="px-3 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white rounded-full font-medium transition shadow-md hover:shadow-lg flex items-center gap-1 sm:gap-2 text-xs sm:text-base min-h-[40px]"
          >
            👤 Perfil
          </Link>
          <button
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 mb-8 sm:mb-12">
          <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl sm:rounded-2xl p-4 sm:p-6 text-white shadow-lg transform hover:-translate-y-1 transition duration-300">
            ...
            <div className="text-blue-100 text-sm sm:text-base">Reservas realizadas</div>
          </div>
          <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-xl sm:rounded-2xl p-4 sm:p-6 text-white shadow-lg transform hover:-translate-y-1 transition duration-300">
            ...
            <div className="text-green-100 text-sm sm:text-base">Reservas confirmadas</div>
          </div>
          <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl sm:rounded-2xl p-4 sm:p-6 text-white shadow-lg transform hover:-translate-y-1 transition duration-300">
            ...
            <div className="text-purple-100 text-sm sm:text-base">Total gasto</div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl overflow-hidden">
          <div className="bg-gradient-to-r from-gray-800 to-gray-900 px-4 sm:px-6 py-4 sm:py-5">
            <h3 className="text-xl sm:text-2xl font-semibold text-white">Minhas Contratações</h3>
            <p className="text-gray-300 text-xs sm:text-sm mt-1">Gerencie suas reservas e experiências</p>
          </div>

          {bookings.length === 0 ? (
            <div className="p-8 sm:p-16 text-center">
              <div className="text-6xl sm:text-8xl mb-4 sm:mb-6">🎯</div>
              <h4 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-2 sm:mb-3">Nenhuma reserva ainda</h4>
              <p className="text-gray-500 text-sm sm:text-base mb-6 sm:mb-8 max-w-md mx-auto">
                Comece a explorar e contrate sua primeira atração!
              </p>
              <Link
                href="/attractions"
